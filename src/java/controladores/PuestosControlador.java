...
public class PuestosControlador {
    ...
    public static boolean agregar(Puestos puesto) {
        ...
        if (Conexion.conectar()) {
            ...
            try {
                ...
                Logger.getLogger(PuestosControlador.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public static Puestos buscarId(Puestos puesto) {
        if (Conexion.conectar()) {
            String sql = "select * from puestos p, establecimientos e where p.id_establecimiento = e.id_establecimiento and p.id_puesto ='" + puesto.getId_puesto() + "'";
    ...
    public static String buscarNombre(String nombre, int pagina) {
        ...
        if (Conexion.conectar()) {
            ...
            try {
                ...
                String sql = "select * from puestos where upper(nombre_puesto) like '%"
                        + nombre.toUpperCase() + "%'"
    ...
    public static Puestos buscarPuesto(Puestos puesto) {
        if (Conexion.conectar()) {
            String sql = "select * from puestos where nombre_puesto ='" + puesto.getNombre_puesto() + "'";
