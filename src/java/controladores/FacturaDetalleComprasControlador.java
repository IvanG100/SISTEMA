            ...
            try {
                ...
                try (PreparedStatement ps = Conexion.getConn().prepareStatement(sql)) {
                    ...
                    while (rs.next()) {
                        ...
                        int venta = rs.getInt("precio_compra");
                    ...
                    if(tabla.equals("")){
                        ...
                        String sql2 = "select sum(cantidad_compra * precio_compra) + " + total + " as TotalaPagar from factura_detalle_compras fdc left join factura_compras fc on fc.id_factura_compra=fdc.id_factura_compra left join articulos a on a.id_articulo=fdc.id_articulo where fdc.id_factura_compra="+ id + "";
