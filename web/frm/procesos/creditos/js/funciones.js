function agregarAprobacionCredito() {
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            limpiarFormulario();
            $("#id_aprobacioncredito").focus();
            $("#id_aprobacioncredito").select();
        },
        error: function (e) {
...
function buscarIdAprobacionCredito() {
    ...
    $.ajax({
        ...
        success: function (json) {
            $("#mensajes").html(json.mensaje);
            $("#id_aprobacioncredito").val(json.id_aprobacioncredito);
